...
Public Const STANDARD_BOUNTY_HUNTER_Message As String = "Se te otorgó un premio por ayudar al proyecto reportando bugs, el mismo está disponible en tu bóveda."
...
Public Type UserFlags
    ...
    TargetObjIndex As Integer 'Obj señalado
