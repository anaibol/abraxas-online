...
On Error GoTo Err
    ...
    'Intervalos
    Call WriteVar(ServidorIni, "INTERVALOS", "SanaIntervaloSinDescansar", str(SanaIntervaloSinDescansar))
    Call WriteVar(ServidorIni, "INTERVALOS", "StaminaIntervaloSinDescansar", str(StaminaIntervaloSinDescansar))
    Call WriteVar(ServidorIni, "INTERVALOS", "SanaIntervaloDescansar", str(SanaIntervaloDescansar))
    Call WriteVar(ServidorIni, "INTERVALOS", "StaminaIntervaloDescansar", str(StaminaIntervaloDescansar))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloSed", str(IntervaloSed))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloHambre", str(IntervaloHambre))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloVeneno", str(IntervaloVeneno))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloParalizado", str(IntervaloParalizado))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloInvisible", str(IntervaloInvisible))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloFrio", str(IntervaloFrio))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloWAVFX", str(IntervaloWavFx))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloInvocacion", str(IntervaloInvocacion))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloParaConexion", str(IntervaloParaConexion))
    
    '&&&&&&&&&&&&&&&&&&&&& TIMERS &&&&&&&&&&&&&&&&&&&&&&&
    
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloLanzaHechizo", str(IntervaloUserPuedeCastear))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloNpcAI", frmMain.TIMER_AI.Interval)
    'Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloNpcAI", frmMain.TIMER_PET_AI.Interval)
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloNpcPuedeAtacar", frmMain.NpcAtaca.Interval)
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloTrabajo", str(IntervaloUserPuedeTrabajar))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloUserPuedeAtacar", str(IntervaloUserPuedeAtacar))
    Call WriteVar(ServidorIni, "INTERVALOS", "IntervaloPerdidaStaminaLluvia", frmMain.tLluvia.Interval)
