...
Private Sub Form_Load()
    ...
    Picture = LoadPicture(GrhPath & "VentanaCarpinteríaItems.jpg")
    LoadButtons
End Sub
...
Private Sub LoadButtons()
    ...
    Set Pestanias(ePestania.ieItems) = LoadPicture(GrhPath & "VentanaCarpinteríaItems.jpg")
    Set Pestanias(ePestania.ieMejorar) = LoadPicture(GrhPath & "VentanaCarpinteríaMejorar.jpg")
    
    Set picCheck = LoadPicture(GrhPath & "CheckBoxCarpintería.jpg")
    ...
    Call cBotonCerrar.Initialize(imgCerrar, GrhPath & "BotónCerrarCarpintería.jpg", _
                                    GrhPath & "BotónCerrarRolloverCarpintería.jpg", _
                                    GrhPath & "BotónCerrarClickCarpintería.jpg", Me)
                                    
    Call cBotonConstruir(0).Initialize(imgConstruir0, GrhPath & "BotónConstruirCarpintería.jpg", _
                                    GrhPath & "BotónConstruirRolloverCarpintería.jpg", _
                                    GrhPath & "BotónConstruirClickCarpintería.jpg", Me)
                                    
    Call cBotonConstruir(1).Initialize(imgConstruir1, GrhPath & "BotónConstruirCarpintería.jpg", _
                                    GrhPath & "BotónConstruirRolloverCarpintería.jpg", _
                                    GrhPath & "BotónConstruirClickCarpintería.jpg", Me)
                                    
    Call cBotonConstruir(2).Initialize(imgConstruir2, GrhPath & "BotónConstruirCarpintería.jpg", _
                                    GrhPath & "BotónConstruirRolloverCarpintería.jpg", _
                                    GrhPath & "BotónConstruirClickCarpintería.jpg", Me)
                                    
    Call cBotonConstruir(3).Initialize(imgConstruir3, GrhPath & "BotónConstruirCarpintería.jpg", _
                                    GrhPath & "BotónConstruirRolloverCarpintería.jpg", _
                                    GrhPath & "BotónConstruirClickCarpintería.jpg", Me)
    
    Call cBotonMejorar(0).Initialize(imgMejorar0, GrhPath & "BotónMejorarCarpintería.jpg", _
                                    GrhPath & "BotónMejorarRolloverCarpintería.jpg", _
                                    GrhPath & "BotónMejorarClickCarpintería.jpg", Me)
    
    Call cBotonMejorar(1).Initialize(imgMejorar1, GrhPath & "BotónMejorarCarpintería.jpg", _
                                    GrhPath & "BotónMejorarRolloverCarpintería.jpg", _
                                    GrhPath & "BotónMejorarClickCarpintería.jpg", Me)
    
    Call cBotonMejorar(2).Initialize(imgMejorar2, GrhPath & "BotónMejorarCarpintería.jpg", _
                                    GrhPath & "BotónMejorarRolloverCarpintería.jpg", _
                                    GrhPath & "BotónMejorarClickCarpintería.jpg", Me)
    
    Call cBotonMejorar(3).Initialize(imgMejorar3, GrhPath & "BotónMejorarCarpintería.jpg", _
                                    GrhPath & "BotónMejorarRolloverCarpintería.jpg", _
                                    GrhPath & "BotónMejorarClickCarpintería.jpg", Me)
    ...
    For i = 1 To MAX_LIST_Items
        If i + Inicio <= NumItems Then
            With ObjCarpintero(i + Inicio)
                ...
                'Inventario de leños
                Call InvMaderasCarpinteria(i).SetSlot(1, 0, .Madera, Wood_Grh, 0, 0, 0, 0, 0, 0, "Leña", True, False)
                Call InvMaderasCarpinteria(i).SetSlot(2, 0, .MaderaElfica, Elf_Wood_Grh, 0, 0, 0, 0, 0, 0, "Leña élfica", True, False)
            End With
        End If
    Next i
End Sub
...
Private Sub imgPestania_Click(Index As Integer)
    ...
    Select Case Index
        Case ePestania.ieItems
            'Background
            Picture = Pestanias(ePestania.ieItems)
