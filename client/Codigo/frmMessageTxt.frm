...
Private Sub Form_Load()
    ...
    Picture = LoadPicture(GrhPath & "VentanaMensajesPersonalizados.jpg")
...
Private Sub LoadButtons()
    ...
    Call cBotonGuardar.Initialize(imgGuardar, GrhPath & "BotónGuardarCustomMsg.jpg", GrhPath & "BotónGuardarRolloverCustomMsg.jpg", _
                                    GrhPath & "BotónGuardarClickCustomMsg.jpg", Me)
    Call cBotonCancelar.Initialize(imgCancelar, GrhPath & "BotónCancelarCustomMsg.jpg", GrhPath & "BotónCancelarRolloverCustomMsg.jpg", _
                                    GrhPath & "BotónCancelarClickCustomMsg.jpg", Me)
End Sub
